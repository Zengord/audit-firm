(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".trust-us__slider")) new core(".trust-us__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
            ...
            speed: 800,
            navigation: {
                prevEl: ".trust-us-button-prev",
                nextEl: ".trust-us-button-next"
            },
            breakpoints: {
                1200: {
                    slidesPerView: 6
    ...
    [].forEach.call(document.querySelectorAll(".input-number"), (function(input) {
        ...
        function mask(event) {
            ...
            let matrix = "+7 (___) ___-__-__", i = 0, def = matrix.replace(/\D/g, ""), val = this.value.replace(/\D/g, ""), newValue = matrix.replace(/[_\d]/g, (function(a) {
